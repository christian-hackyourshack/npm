...
<Wrap>
  <Card href="/features/default-frontmatter">
    **Default frontmatter**
  ...
  <Card href="/features/export-components">
    **Export `components`**
  ...
  <Card href="/features/auto-imports">
    **Auto `import`**
  ...
  <Card href="/features/inject-rawmdx">
    **Inject raw MDX**

    Get (read-only) access to the (really) raw MDX content of your file.

  </Card>
  <Card href="/features/inject-mdast">
    **Inject MDAST**
  ...
  <Card href="/features/scan-title">
    **Scan title**

    Scan the document content for the title.

  </Card>
  <Card href="/features/scan-abstract">
    **Scan abstract**
