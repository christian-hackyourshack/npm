...
# Welcome to :style[Astro-M²DX]{.shine}
...
![Astronaut vacuuming stars](./astronaut.jpg):style{.square}
...
Check out [the blog](/blog), highlighting individual features, or check out [the docs](/docs).
